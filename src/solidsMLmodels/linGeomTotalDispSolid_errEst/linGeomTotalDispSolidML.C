        ...
        void linGeomTotalDispSolidML::updateD_ML()
        {
            ...
            forAll(D(), cellI)
            {
                ...
                if (useCoordinates_)
                {
                    ...
                    scaledInput[coord_loc * 2] = scale(inputFoam[coord_loc].x(), kerasScalingMeans_[coord_loc].x(), kerasScalingStds_[coord_loc].x());
                    scaledInput[coord_loc * 2 + 1] = scale(inputFoam[coord_loc].y(), kerasScalingMeans_[coord_loc].y(), kerasScalingStds_[coord_loc].y());
                }
