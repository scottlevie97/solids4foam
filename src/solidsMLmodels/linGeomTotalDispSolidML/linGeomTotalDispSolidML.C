    ...
    namespace solidModels
    {
        ...
        void linGeomTotalDispSolidML::updateD_ML()
        {
            ...
            forAll(D(), cellI)
            {
                ...
                const int inputVectorSize = (machinePredictorIter_)*3;
                ...
                const std::vector<double> result =
                    {
                        invScale(scaledResult[0], kerasScalingMeans_[machinePredictorIter_][0], kerasScalingStds_[machinePredictorIter_][0]),
                        invScale(scaledResult[1], kerasScalingMeans_[machinePredictorIter_][1], kerasScalingStds_[machinePredictorIter_][1]),
                        invScale(scaledResult[2], kerasScalingMeans_[machinePredictorIter_][2], kerasScalingStds_[machinePredictorIter_][2]),
                    };
